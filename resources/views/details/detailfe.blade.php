...
<section id="detail" class="detail">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3><span style="color: #FBB041;">Rapid</span> Bootcamp Frontend</h3>
                <p>Kami dapat membantumu mendapatkan pekerjaan impian sebagai Frontend Developer Expert dalam hitungan bulan!</p>
            </div>
        </div>
    </div>
</section>
<section id="silabus" class="silabus mb-4">
    <div class="container">
        <div class="row" >
            <div class="col-lg-6">
                <h3>Our Rapid Bootcamp Frontend Syllabus:</h3>
                <ul id="accordion">
                    <li>
                    ...
                    <li>
                        <label for="second">2. Frontend Developer Career Path<span>&#x3e</span> </label>
                        <input type="radio" name="accordion" id="second" >
                        <div class="content">
                            <p>(a) Introduction to Frontend Web Developer. <br>
                    ...
                    <li>
                        <label for="fourth">4. CSS Fundamental <span>&#x3e</span> </label>
                    ...
                    <li>
                        <label for="five">5. Javascript Fundamnetal <span>&#x3e</span> </label>
