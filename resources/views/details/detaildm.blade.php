...
<section id="detail" class="detail">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3><span style="color: #FBB041;">Rapid</span> Digital Marketing</h3>
                <p>Kami dapat membantumu mendapatkan pekerjaan impian sebagai Digital Marketing dalam hitungan bulan</p>
            </div>
        </div>
    </div>
</section>
<section id="silabus" class="silabus mb-4">
    <div class="container">
        <div class="row" >
            <div class="col-lg-6">
                <h3>Our Rapid Bootcamp Digital Marketing Syllabus:</h3>
                <ul id="accordion">
                    <li>
                        <label for="first">1. Paid Channel Deep Dive <span>&#x3e</span> </label>
                    ...
                    <li>
                        <label for="second">2. Socials Media Fundamental<span>&#x3e</span> </label>
                    ...
                    <li>
                        <label for="third">3.Socials Media Deep Dive<span>&#x3e</span> </label>
                    ...
                    <li>
                        <label for="fourth">4. Google Ads Fundamental <span>&#x3e</span> </label>
